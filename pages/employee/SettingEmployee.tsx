        ...
        switch (param) {
            ...
            case "Availability":  
                return <> 
                    ...
                    <input type="text" className='rounded-[43px] py-[6px] px-4 mb-6 w-full border-2' name="" id="" placeholder='Date' />
                    <input type="text" className='rounded-[43px] py-[6px] px-4 mb-6 w-full border-2' name="" id="" placeholder='Time' />
                    <input type="text" className='rounded-[43px] py-[6px] px-4 mb-6 w-full border-2' name="" id="" placeholder='Available' /> 
                    <button className='text-white bg-primary w-full rounded-[43px] py-[8px]'>Confirm</button>
            ...
            <section>
                ...
                <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
                    ...
                    >
                        ...
                        <Tab value="Availability" label="Availability" style={{ color: "#0F87E4", fontFamily: "'Poppins', sans-serif", fontWeight: "600" }} />
