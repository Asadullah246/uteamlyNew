            ...
            <section>
                ...
                <section className='flex justify-start'>  
                    <div id="chart" className='shadow-2xl rounded-[8px]'>
                        <ReactApexChart options={chartData.options} series={chartData.series} type="bar" height={300} width={500} />
                    </div>
                    <div>
                        <p>Start the day </p>
                        <button className='bg-primary py-1 px-6 text-white rounded-md'>Sign in</button>
                    </div>
                </section>
            </section>
