                ...
                <table className='w-full border-separate border-spacing-y-2 table-auto'>
                        <thead>
                            <tr className=''>
                                ...
                                <th className='text-start break-words px-2 text-xs md:text-sm lg:text-base '>Start Time</th>
                                <th className='text-start break-words px-2 text-xs md:text-sm lg:text-base '>Duo Time</th>
                                <th className='text-start break-words px-2 text-xs md:text-sm lg:text-base '>Note</th>
                                <th className='text-start break-words px-2 text-xs md:text-sm lg:text-base '>Employee</th>
                            </tr>
                                ...
                                [...Array(4)].map((d, index) => {
                                    return (
                                        <tr key={index + 1} className='rounded border shadow-lg '>
                                            ...
                                            <td className='border-y-2 py-3 break-all px-2 text-xs md:text-sm lg:text-base '>10:00am</td>
                                            <td className='border-y-2 py-3 break-all px-2 text-xs md:text-sm lg:text-base '>10:00pm</td>
                                            <td className='border-y-2 py-3 break-words px-2 text-xs md:text-sm lg:text-base '><Image src={note2} alt="" className='w-[0.95em] h-auto' /></td> 
                                            <td className='border-y-2 text-[0.76em] md:text-[1em]  py-3'>Dinesh Chugtai</td>  
...
export default ClockInCustomer;