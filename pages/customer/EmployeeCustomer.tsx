        ...
        <>
            ...
            <section>
                ...
                <section>
                    ...
                    <button className='bg-primary py-2 px-8 text-white rounded my-3 font-[500] whitespace-nowrap' onClick={handleOpen} >
                        <div className='flex items-center'>
                        <Image src={printImg} alt="" className='w-[0.9em]' />
                        <p className='ml-2'>Print Details</p>
                        </div></button>
                    ...
                    <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
                        ...
                        >
                            <Tab value="Employees" label="Employees"  style={{color:"#0F87E4", fontFamily:"'Poppins', sans-serif", fontWeight:"600"}}/> 
